...
var hostname = "https://amazatic-test-app.herokuapp.com/";
...
function loginUser(){
  ...
  httpRequest("POST",hostname+"login/", headers,data).then(function(res){
...
function createUser(){
  ...
  if(flag){
    httpRequest("POST", hostname+"user/", headers,data).then(function(res){
...
function edit(obj){
  ...
  if(flag){
  httpRequest("PATCH", hostname+"user/"+obj.id+'/',headers, data).then(function(res){
    var user = JSON.parse(res);
    for(var index in user_list){
...
function deleteUser(id){
  headers["Authorization"] = document.cookie;
  httpRequest("DELETE", hostname+"user/"+id+'/',headers).then(function(res){
    for(var index in user_list){
...
function loadUserList() {
  headers["Authorization"] = document.cookie;
  httpRequest("GET", hostname+"user/",headers).then(function(res){
...
function logout(){
  ...
  httpRequest("POST", hostname+"logout/",headers).then(function(res){
